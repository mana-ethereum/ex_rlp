defmodule ExRLP.EncodeTest do
  ...
  test "encodes empty string" do
    ...
    result = string |> Encode.encode(encoding: :hex)
  ...
  test "encodes short string (2)" do
    ...
    expected_result =
      "b74c6f72656d20697073756d20646f6c6f722073697" <>
  ...
  test "encodes long string (1)" do
    ...
    expected_result =
      "b8384c6f72656d20697073756d20646f6c6f722073697" <>
  ...
  test "encodes long string (2)" do
    ...
    expected_result =
      "b904004c6f72656d20697073756d20646f6c6f722073697420616d65742c20636f6" <>
  ...
  test "encodes medium integer (4)" do
    string = 83_729_609_699_884_896_815_286_331_701_780_722
  ...
  test "encodes medium integer (5)" do
    string =
      105_315_505_618_206_987_246_253_880_190_783_558_935_785_933_862_974_822_347_068_935_681
  ...
  test "encodes string list" do
    ...
    result = list |> Encode.encode(encoding: :hex)
  ...
  test "encodes max short list" do
    ...
    expected_result =
      "f784617364668471776572847a7863768461736466847" <>
  ...
  test "encodes long list (1)" do
    ...
    expected_result =
      "f840cf84617364668471776572847a786376cf84617364668" <>
  ...
  test "encodes long list (2)" do
    ...
    expected_result =
      "f90200cf84617364668471776572847a786376cf" <>
  ...
  test "encodes dictionary" do
    ...
    expected_result =
      "ecca846b6579318476616c31ca846b65" <>
  ...
  test "encoded big integer" do
    ...
    result = big_integer |> Encode.encode(encoding: :hex)
